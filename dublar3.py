...
def main():
    ...
    ap.add_argument("--out", dest="out", default=None)  # <-- agora default é None
    ...
    # <<< NOVO: define pasta "dublado" e cria se não existir >>>
    outdir = Path("dublado")
    outdir.mkdir(exist_ok=True)

    # <<< NOVO: define nome do arquivo de saída com mesmo nome do vídeo original >>>
    if args.out:
        out_mp4 = Path(args.out)
    else:
        out_mp4 = outdir / video_in.name
